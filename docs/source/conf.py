...
project = "Lightworks"
project_copyright = f"{datetime.now(tz=timezone.utc).year}, Aegiq Ltd."  # ruff: ignore[datetime-timezone-utc]
author = "Aegiq Ltd."
...
os.environ["PYTHONPATH"] = os.path.abspath("../../../lightworks")  # ruff: ignore[os-path-abspath]
